...
Run ID：exp4_20260514_132953

生成时间：2026-05-14T13:29:56
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| monolithic_rewrite | 0.120 | 3.545 | 2 | 周期性把长上下文压缩为很短摘要，容易在压缩点丢失早期技能并触发 context collapse。 | 44 | 0.560 | 1.000 | 0.880 | 10980 | 0.763 | 0.780 | 1.000 | 13960 | Periodic Rewrite Baseline | 0.440 | 0.717 | 0.560 | 1.000 |
| append_only | 0.120 | 3.342 | 0 | 只追加任务记录和经验，不做结构化精炼；上下文持续膨胀，到达预算后被动截断。 | 78 | 0.220 | 1.000 | 0.900 | 15053 | 0.920 | 0.722 | 1.000 | 27652 | Append-only Baseline | 0.780 | 0.617 | 0.220 | 1.000 |
| ace_grow_and_refine | 0.120 | 2.848 | 0 | ACE 将任务反馈沉淀为结构化经验，并阶段性合并、去冗余和保留核心技能，使上下文平稳增长或温和精简。 | 2 | 0.980 | 1.000 | 0.900 | 12028 | 0.000 | 0.970 | 1.000 | 12028 | ACE Grow-and-Refine | 0.000 | 0.945 | 0.980 | 1.000 |
