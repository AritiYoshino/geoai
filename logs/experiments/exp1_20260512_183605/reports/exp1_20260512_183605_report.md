...
Run ID：exp1_20260512_183605

生成时间：2026-05-12T18:36:09
...
任务展开规模：12 个任务单元；本次 trace 数：36；成功 32，失败 4。
...
| buffer_analysis | 1 |
| code_required | 1 |
| experience_evolution | 1 |
| experience_retrieval | 1 |
| hotspot | 1 |
| memory_followup | 1 |
| memory_seed | 1 |
| nearby_analysis | 1 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| base_agent | 0.107 | 2.500 | 1.000 | 3 | 0.750 | 0.000 | 0.000 | 0.000 | 0.875 | 0.750 | 0.917 | 0 |
| rag_agent | 0.110 | 3.100 | 1.000 | 1 | 0.917 | 0.000 | 1.000 | 0.000 | 0.930 | 0.917 | 0.917 | 0 |
| ace_agent | 0.113 | 3.500 | 1.000 | 0 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 0 |
