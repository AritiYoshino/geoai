...
Run ID：exp3_20260512_140126

生成时间：2026-05-13T14:57:03
...
任务展开规模：30 个任务单元；本次 trace 数：180；成功 80，失败 100。

任务文件：`data/experiments/tasks_ablation.json`。
...
| 组别 | average_latency | correct_tool_chain_rate | error_count | experience_quality_score | first_try_success_rate | self_repair_rate | success_rate | token_usage |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| full_ace | 1.135 | 1.000 | 9 | 0.833 | 0.067 | 0.556 | 0.700 | 6600 |
| without_critic | 1.106 | 1.000 | 21 | 0.630 | 0.000 | 0.000 | 0.300 | 6600 |
| without_evolution | 1.069 | 1.000 | 12 | 0.633 | 0.000 | 0.417 | 0.600 | 6600 |
| without_experience_retrieval | 1.018 | 1.000 | 22 | 0.618 | 0.000 | 0.455 | 0.267 | 5088 |
| without_code_agent | 0.962 | 0.900 | 16 | 0.769 | 0.000 | 0.125 | 0.467 | 6600 |
| without_context_manager | 1.014 | 1.000 | 20 | 0.825 | 0.000 | 0.500 | 0.333 | 6600 |
...
实验三中完整 ACE 成功率为 0.700；各消融组与 full_ace 的差距可用于分析 Critic、Evolution、经验检索、CodeAgent 和 ContextManager 的贡献。
