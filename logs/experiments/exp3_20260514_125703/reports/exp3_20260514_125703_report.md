...
Run ID：exp3_20260514_125703

生成时间：2026-05-14T12:57:07
...
任务展开规模：8 个任务单元；本次 trace 数：48；成功 32，失败 16。
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| full_ace | 0.165 | 3.556 | 完整启用 ContextManager、Experience Retrieval、CodeAgent、Critic 与 Evolution。 | 0 | 1.000 | 0.375 | 0.500 | [] | Full ACE | 0.000 | 0.000 | 1.000 | 1.000 | 1.000 | 0 |
| without_critic | 0.165 | 3.850 | 移除 CriticAgent：不能诊断错误原因，Evolution 缺少高质量错误归因。 | 4 | 0.500 | 0.000 | 0.500 | ['critic'] | ACE w/o Critic | 0.000 | 0.375 | 0.870 | 0.500 | 1.000 | 0 |
| without_evolution | 0.165 | 3.850 | 移除 EvolutionAgent：可以执行和诊断，但不能把新策略沉淀到经验库。 | 3 | 0.625 | 0.000 | 0.500 | ['evolution'] | ACE w/o Evolution | 0.000 | 0.375 | 0.907 | 0.625 | 1.000 | 0 |
| without_experience_retrieval | 0.165 | 4.006 | 移除经验检索：无法复用 CRS、空结果恢复、动态缓冲等已有经验。 | 4 | 0.500 | 0.375 | 0.000 | ['experience_retrieval'] | ACE w/o Experience Retrieval | 0.000 | 0.500 | 0.833 | 0.500 | 1.000 | 0 |
| without_code_agent | 0.150 | 3.906 | 移除 CodeAgent：无法执行 GeoPandas 代码和精确数值校验。 | 3 | 0.625 | 0.375 | 0.500 | ['code_agent'] | ACE w/o CodeAgent | 0.000 | 0.375 | 0.857 | 0.625 | 0.750 | 0 |
| without_context_manager | 0.155 | 3.906 | 移除 ContextManager：无法读取跨轮锚点、偏好和上下文引用。 | 2 | 0.750 | 0.375 | 0.500 | ['context_manager'] | ACE w/o ContextManager | 0.000 | 0.000 | 0.911 | 0.750 | 0.875 | 0 |
