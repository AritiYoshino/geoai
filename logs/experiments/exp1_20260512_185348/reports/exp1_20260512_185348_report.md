...
Run ID：exp1_20260512_185348

生成时间：2026-05-12T18:53:53
...
任务展开规模：20 个任务单元；本次 trace 数：60；成功 41，失败 19。
...
| buffer_analysis | 1 |
| code_required | 2 |
| experience_evolution | 2 |
| experience_retrieval | 3 |
| hotspot | 1 |
| memory_followup | 3 |
| memory_seed | 2 |
| nearby_analysis | 1 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| base_agent | 0.107 | 2.600 | 1.000 | 11 | 0.450 | 0.000 | 0.000 | 0.000 | 0.756 | 0.450 | 0.867 | 0 |
| rag_agent | 0.110 | 3.200 | 1.000 | 8 | 0.600 | 0.000 | 1.000 | 0.000 | 0.840 | 0.600 | 0.783 | 0 |
| ace_agent | 0.113 | 3.600 | 1.000 | 0 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 1.000 | 0.950 | 0 |
