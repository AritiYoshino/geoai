...
Run ID：exp2_20260512_230926

生成时间：2026-05-12T23:09:41
...
实验二将任务按 batch 连续输入，观察经验库积累后 ACE-WebGIS 是否在后续 batch 中提升成功率、降低重复错误并提高经验复用。

任务展开规模：20 个任务单元；本次 trace 数：60；成功 20，失败 40。
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| codeact_agent | 0.162 | 3.876 | 20 | 0.000 | 0.000 | 0.000 | 0.000 | 0.900 | 0.639 | 0.000 | 0.900 | 20 |
| rag_agent | 0.166 | 3.474 | 20 | 0.000 | 0.000 | 0.000 | 0.000 | 0.900 | 0.652 | 0.000 | 0.950 | 20 |
| ace_webgis | 0.166 | 3.119 | 0 | 1.000 | 0.300 | 0.650 | 0.000 | 0.000 | 1.000 | 1.000 | 0.950 | 0 |
...
实验二中 ACE 成功率从 1.000 变化到 1.000，可结合经验复用率和新经验数量解释连续学习趋势。

DeepSeek 总结生成失败：Connection error.
