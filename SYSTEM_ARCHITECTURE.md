...
- `static/` 静态资源：
  ...
  - `js/experiment/`：实验页面拆分模块
    - [`chart_setup.js`](web_app/static/js/experiment/chart_setup.js)：Chart.js 图表配置
    - [`logic.js`](web_app/static/js/experiment/logic.js)：实验运行与结果管理逻辑
    - [`main.js`](web_app/static/js/experiment/main.js)：实验页面入口
    - [`state.js`](web_app/static/js/experiment/state.js)：实验状态管理
